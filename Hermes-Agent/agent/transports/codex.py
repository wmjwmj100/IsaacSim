...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        is_ark_responses = "ark.cn-beijing.volces.com" in base_url
        replay_encrypted_reasoning = bool(
        ...
        if not is_github_responses and not is_xai_responses and not is_ark_responses and session_id:
        ...
        elif reasoning_enabled and not is_ark_responses:
        ...
        elif not is_github_responses and not is_xai_responses and not is_ark_responses:
            kwargs["include"] = []
